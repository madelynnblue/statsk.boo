...
mod tests {
    ...
    // `openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:2048 -out /tmp/statskboo-test-key.pem`
    ...
    // `openssl pkey -in /tmp/statskboo-test-key.pem -pubout`. jsonwebtoken's
    ...
    const SA_JSON: &str = r#"{
        ...
        "project_id": "statskboo-test",
        "private_key_id": "abc123",
        "private_key": "-----BEGIN PRIVATE KEY-----\nMIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQCx\nfake\n-----END PRIVATE KEY-----\n",
        "client_email": "statskboo-test@statskboo-test.iam.gserviceaccount.com",
        "client_id": "1234567890",
        "auth_uri": "https://accounts.google.com/o/oauth2/auth",
        "token_uri": "https://oauth2.googleapis.com/token",
        "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
        "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/statskboo-test%40statskboo-test.iam.gserviceaccount.com"
    }"#;
    ...
    fn test_from_file_parses_and_decodes_escaped_newlines() {
        let dir = std::env::temp_dir().join(format!("statskboo-sa-test-{}", std::process::id()));
        let p = write_sa_json(&dir, SA_JSON);
        let sa = ServiceAccount::from_file(&p).unwrap();
        assert_eq!(
            sa.client_email,
            "statskboo-test@statskboo-test.iam.gserviceaccount.com"
        );
    ...
    fn test_build_jwt_claims() {
        let sa = ServiceAccount {
            client_email: "statskboo-test@statskboo-test.iam.gserviceaccount.com".into(),
